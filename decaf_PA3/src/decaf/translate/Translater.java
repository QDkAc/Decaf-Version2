...
public class Translater {
	...
	public Temp genLoad(Temp base, Temp offest) {
		Temp dst = Temp.createTempI4();
		append(Tac.genLoad(dst, base, offest));
		return dst;
	}
	...
	public void genStore(Temp src, Temp base, Temp offset) {
		append(Tac.genStore(src, base, offset));
	}
	...
	public void genCheckDivideZero(Temp val) {
		Label exit = Label.createLabel();
		Temp cond = genEqu(val, genLoadImm4(0));
		genBeqz(cond, exit);
