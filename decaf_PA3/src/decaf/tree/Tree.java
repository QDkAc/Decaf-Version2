...
public abstract class Tree {
    ...
    public static final int GUARDEDIF = PRINT + 1;
    public static final int GUARDEDDO = GUARDEDIF + 1;
    public static final int GUARDED = GUARDEDDO + 1;
    public static final int COND = GUARDED + 1;
    public static final int TYPECOUNT = COND +1;
    ...
    /**
     * A guarded if statement.
     */
    public static class GuardedIf extends Tree {

       public List<Tree> glist;

       public GuardedIf(List<Tree> glist, Location loc) {
           super(GUARDEDIF, loc);
           this.glist = glist;
       }
    ...
    /**
     * A guarded do statement.
     */
    public static class GuardedDo extends Tree {

       public List<Tree> glist;

       public GuardedDo(List<Tree> glist, Location loc) {
           super(GUARDEDDO, loc);
           this.glist = glist;
       }
    ...
    public static class Guarded extends Tree {
       ...
       public Guarded(Expr expr, Tree stmt, Location loc) {
           super(GUARDED, loc);
           this.expr = expr;
           this.stmt = stmt;
       }
   ...
   public static class Ternary extends Expr {
   	...
   	public Expr bool, expr1, expr2;

       public Ternary(int kind, Expr bool, Expr expr1, Expr expr2, Location loc) {
           super(kind, loc);
   		this.bool = bool;
   		this.expr1 = expr1;
   		this.expr2 = expr2;
